      ...
      <div className=" flex items-center justify-between rounded-[10px]  border-[3px] py-[12px] border-slate-300">
        ...
        <div className=" flex items-center gap-x-[7px] text-[17px] font-bold mx-5">
          ...
          <a
            ...
            target="_blank"
          >
            0x128733E87074F39D2b77E5e1101C2047CC553cb0
          </a>
        </div>
        <div className=" flex items-center gap-x-[7px] text-[17px] font-bold mx-5">
      ...
      <div className=" flex flex-col justify-center items-center mt-3">
        <table className=" w-full mx-5">
          <thead className="p-3 text-white text-[19px]">
            <tr>
              <th className=" rounded-tl-[10px] py-3 bg-[#211951]">No.</th>
              <th className=" py-3 bg-[#211951]">Funders</th>
              <th className=" py-3 bg-[#211951]">Fund</th>
              <th className=" rounded-tr-[10px] py-3 bg-[#211951]">Date</th>
            </tr>
          </thead>
